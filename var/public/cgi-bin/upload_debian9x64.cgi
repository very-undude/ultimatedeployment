...
$osinfo{NETBOOTIMAGE}="debian9x64/$osinfo{FLAVOR}/".$query->param('NETBOOTIMAGE');

local($osdir)="/var/public/tftproot/debian9x64";
...
require "os/debian9x64.pl";
%formdata=();
$formdata{OS}="debian9x64";
...
local($result)=&debian9x64_ImportOS("debian9x64");
if ($result)
{
...
# &PrintSuccess("Import of debian9x64 operating system $osinfo{FLAVOR} succesfull");
