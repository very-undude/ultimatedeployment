...
$osinfo{NETBOOTIMAGE}="debian8/$osinfo{FLAVOR}/".$query->param('NETBOOTIMAGE');

local($osdir)="/var/public/tftproot/debian8";
...
local($result)=&debian8_ImportOS("debian8");
if ($result)
{
...
# &PrintSuccess("Import of debian8 operating system $osinfo{FLAVOR} succesfull");
