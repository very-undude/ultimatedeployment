...
$osinfo{FLOPPYIMAGE}="vsim/$osinfo{FLAVOR}/".$query->param('FLOPPYIMAGE');

local($osdir)="/var/public/tftproot/vsim";
...
local($flavordir)="/var/public/tftproot/vsim/$osinfo{FLAVOR}";
...
&PrintSuccess("Import of vsim operating system $osinfo{FLAVOR} succesfull");
