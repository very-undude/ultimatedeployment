...
$osinfo{NETBOOTIMAGE}="debian8x64/$osinfo{FLAVOR}/".$query->param('NETBOOTIMAGE');

local($osdir)="/var/public/tftproot/debian8x64";
...
require "os/debian8x64.pl";
%formdata=();
$formdata{OS}="debian8x64";
...
local($result)=&debian8x64_ImportOS("debian8x64");
if ($result)
{
...
# &PrintSuccess("Import of debian8x64 operating system $osinfo{FLAVOR} succesfull");
