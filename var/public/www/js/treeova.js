...
function UpdateOva(mymount,mypath)
{
	...
	ajaxRequest.open("GET", "/cgi-bin/browseova.cgi?mymount="+mymount+"&mypath="+mypath, true);
	ajaxRequest.send(null); 
}

function expandova(path)
{
 curpath=document.getElementById('NEWOVAFILE').value;
 ...
 document.getElementById('NEWOVAFILE').value = curpath;
 mountname=document.getElementById('NEWOVAMOUNT').value;
 UpdateOva(mountname,curpath);
}
