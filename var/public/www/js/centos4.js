function ClearFileSelects()
{
  ...
  for (q=document.forms[0].FILE3.options.length;q>=0;q--)
  {
   document.forms[0].FILE3.options[q]=null ;
  }
  for (q=document.forms[0].FILE4.options.length;q>=0;q--)
  {
   document.forms[0].FILE4.options[q]=null ;
  }
